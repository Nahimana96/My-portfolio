    ...
    <div className="text-center mt-5" id="about">
      ...
      >
        <p className="text-gray-300 my-2 md:w-full leading-[2]">
          ...
          des compétences essentielles telles que l'organisation, la
          collaboration en équipe, et une grande capacité d'écoute, acquises au
          cours de divers projets et stages. <br /> Après ma reconversion
          professionnelle dans le domaine du développement web, j'ai réussi à
          obtenir mon diplôme chez OpenClassRooms, ce qui m' a permis de devenir
          autonome dans la réalisation des projets web. Ma passion pour le
